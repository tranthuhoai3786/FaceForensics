...
#     layers.Dropout(0.15),#giảm overfitting
#
...
#
#     layers.Flatten(),
#     layers.Dense(1000, activation = 'relu'),#fully connected
#     layers.Dense(256, activation = 'relu'),#fully connected
...
# model_training_first.save('model_ff_20epochs.keras')
# import time
...
models = models.load_model('model_ff_20epochs.keras')
while (True):
    OK, frame = cam.read()
